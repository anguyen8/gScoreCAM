from evaluation.parts_imagenet_eval import InfoGroundEval
...
def info_ground_eval(model_name:str = 'RN50x16',
                     ...
                     image_folder:str = '/home/qi/gscorecam/datasets/PartsImageNet/test',
                     meta_file:str = 'meta_data/partsImageNet_parts_test.hdf5',
